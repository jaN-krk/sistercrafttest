...
Stok haber, iletişim/iade talepleri ve sipariş/kargo/teslim/iade olayları mağaza sahibine bildirim oluşturur. Yeni üyelikte mağaza sahibine ad, e-posta ve kayıt zamanı; müşteriye e-posta doğrulama bağlantısı gönderilir. Yeni form taleplerinde müşteriye ayrı bir alındı mesajı kaydedilir. E-postalar HTML ve düz metin içerir. Şifre, ödeme kartı veya kimlik numarası e-postaya eklenmez.
