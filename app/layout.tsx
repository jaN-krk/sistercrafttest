...
export const metadata: Metadata = {title:{default:'SisterCraft&Co | Sana ait bir an',template:'%s | SisterCraft&Co'},description:'Doğal tütsüler, özenle hazırlanan mumlar ve ritüel kutuları. Doğadan ilhamla, senin ritminle.',metadataBase:new URL(siteOrigin)};
